...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [],
        "name": "pmd_dust_test.distribution",
        "sources": [
            "./distribution.pyx"
        ]
    },
    "module_name": "pmd_dust_test.distribution"
}
END: Cython Metadata */
...
#define __PYX_HAVE__pmd_dust_test__distribution
#define __PYX_HAVE_API__pmd_dust_test__distribution
/* Early includes */
#include <string.h>
#include <stdio.h>
...
/* Module declarations from 'pmd_dust_test.distribution' */
...
static PyObject *__pyx_f_13pmd_dust_test_12distribution_compute_depth_bytes(__Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
static PyObject *__pyx_f_13pmd_dust_test_12distribution_normal_distribution(__Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
...
#define __Pyx_MODULE_NAME "pmd_dust_test.distribution"
extern int __pyx_module_is_main_pmd_dust_test__distribution;
int __pyx_module_is_main_pmd_dust_test__distribution = 0;

/* Implementation of 'pmd_dust_test.distribution' */
...
static PyObject *__pyx_pf_13pmd_dust_test_12distribution_compute_depth_bytes(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_data); /* proto */
static PyObject *__pyx_pf_13pmd_dust_test_12distribution_2normal_distribution(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_depth_image); /* proto */
...
/* "pmd_dust_test/distribution.pyx":12
 * 
 * 
...
static PyObject *__pyx_pw_13pmd_dust_test_12distribution_1compute_depth_bytes(PyObject *__pyx_self, PyObject *__pyx_arg_data); /*proto*/
static PyObject *__pyx_f_13pmd_dust_test_12distribution_compute_depth_bytes(__Pyx_memviewslice __pyx_v_data, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_i;
  int __pyx_v_j;
  int __pyx_v_height;
  int __pyx_v_width;
  ...
  /* "pmd_dust_test/distribution.pyx":13
 * 
 * cpdef compute_depth_bytes(unsigned short[:, :] data):
 *     cdef int i, j, height = data.shape[0], width = data.shape[1]             # <<<<<<<<<<<<<<
 *     cdef unsigned short current
 ...
 */
  ...
  /* "pmd_dust_test/distribution.pyx":16
 *     cdef unsigned short current
 * 
 ...
 */
  ...
  /* "pmd_dust_test/distribution.pyx":18
 *     cdef unsigned char[:, :, :] result = np.ones(shape=(height, width, 3), dtype=np.uint8)
 * 
 *     for i in range(height):             # <<<<<<<<<<<<<<
 ...
 */
  ...
  for (__pyx_t_9 = 0; __pyx_t_9 < __pyx_t_8; __pyx_t_9+=1) {
    ...
    /* "pmd_dust_test/distribution.pyx":19
 * 
 *     for i in range(height):
 *         for j in range(width):             # <<<<<<<<<<<<<<
 *             current = data[i, j]
 ...
 */
    ...
    for (__pyx_t_12 = 0; __pyx_t_12 < __pyx_t_11; __pyx_t_12+=1) {
      ...
      /* "pmd_dust_test/distribution.pyx":20
 *     for i in range(height):
 *         for j in range(width):
 *             current = data[i, j]             # <<<<<<<<<<<<<<
 *             result[i, j, 0] = current & 0xFF
 ...
 */
      ...
      /* "pmd_dust_test/distribution.pyx":21
 *         for j in range(width):
 *             current = data[i, j]
 *             result[i, j, 0] = current & 0xFF             # <<<<<<<<<<<<<<
 *             result[i, j, 1] = current >> 8
 ...
 */
      ...
      *((unsigned char *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_result.data + __pyx_t_16 * __pyx_v_result.strides[0]) ) + __pyx_t_17 * __pyx_v_result.strides[1]) ) + __pyx_t_18 * __pyx_v_result.strides[2]) )) = (__pyx_v_current & 0xFF);
      ...
      /* "pmd_dust_test/distribution.pyx":22
 *             current = data[i, j]
 *             result[i, j, 0] = current & 0xFF
 *             result[i, j, 1] = current >> 8             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "pmd_dust_test/distribution.pyx":24
 *             result[i, j, 1] = current >> 8
 * 
 *     return np.asarray(result)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_AddTraceback("pmd_dust_test.distribution.compute_depth_bytes", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
...
/* Python wrapper */
static PyObject *__pyx_pw_13pmd_dust_test_12distribution_1compute_depth_bytes(PyObject *__pyx_self, PyObject *__pyx_arg_data); /*proto*/
static PyObject *__pyx_pw_13pmd_dust_test_12distribution_1compute_depth_bytes(PyObject *__pyx_self, PyObject *__pyx_arg_data) {
  ...
  __pyx_r = __pyx_pf_13pmd_dust_test_12distribution_compute_depth_bytes(__pyx_self, __pyx_v_data);
...
static PyObject *__pyx_pf_13pmd_dust_test_12distribution_compute_depth_bytes(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_data) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannySetupContext("compute_depth_bytes", 0);
  ...
  __pyx_t_1 = __pyx_f_13pmd_dust_test_12distribution_compute_depth_bytes(__pyx_v_data, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 12, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
/* "pmd_dust_test/distribution.pyx":27
 * 
 * 
...
static PyObject *__pyx_pw_13pmd_dust_test_12distribution_3normal_distribution(PyObject *__pyx_self, PyObject *__pyx_arg_depth_image); /*proto*/
static PyObject *__pyx_f_13pmd_dust_test_12distribution_normal_distribution(__Pyx_memviewslice __pyx_v_depth_image, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_i;
  int __pyx_v_j;
  int __pyx_v_height;
  int __pyx_v_width;
  ...
  /* "pmd_dust_test/distribution.pyx":30
 *     """Calculates the standard deviation for this population"""
 * 
 ...
 */
  ...
  /* "pmd_dust_test/distribution.pyx":31
 * 
 *     cdef int i, j, ij, height = depth_image.shape[0], width = depth_image.shape[1]
 *     cdef double mew_sum = 0, count = 0             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "pmd_dust_test/distribution.pyx":33
 *     cdef double mew_sum = 0, count = 0
 * 
 *     for i in range(height):  # , nogil=True):             # <<<<<<<<<<<<<<
 *         for j in range(width):
 ...
 */
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    ...
    /* "pmd_dust_test/distribution.pyx":34
 * 
 *     for i in range(height):  # , nogil=True):
 *         for j in range(width):             # <<<<<<<<<<<<<<
 *             mew_sum += depth_image[i, j]
 ...
 */
    ...
    for (__pyx_t_6 = 0; __pyx_t_6 < __pyx_t_5; __pyx_t_6+=1) {
      ...
      /* "pmd_dust_test/distribution.pyx":35
 *     for i in range(height):  # , nogil=True):
 *         for j in range(width):
 *             mew_sum += depth_image[i, j]             # <<<<<<<<<<<<<<
 *             count += 1
 ...
 */
      ...
      __pyx_t_9 = -1;
      if (__pyx_t_7 < 0) {
        __pyx_t_7 += __pyx_v_depth_image.shape[0];
        if (unlikely(__pyx_t_7 < 0)) __pyx_t_9 = 0;
      } else if (unlikely(__pyx_t_7 >= __pyx_v_depth_image.shape[0])) __pyx_t_9 = 0;
      if (__pyx_t_8 < 0) {
        __pyx_t_8 += __pyx_v_depth_image.shape[1];
        if (unlikely(__pyx_t_8 < 0)) __pyx_t_9 = 1;
      } else if (unlikely(__pyx_t_8 >= __pyx_v_depth_image.shape[1])) __pyx_t_9 = 1;
      if (unlikely(__pyx_t_9 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_9);
        __PYX_ERR(0, 35, __pyx_L1_error)
      }
      __pyx_v_mew_sum = (__pyx_v_mew_sum + (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_depth_image.data + __pyx_t_7 * __pyx_v_depth_image.strides[0]) ) + __pyx_t_8 * __pyx_v_depth_image.strides[1]) ))));

      /* "pmd_dust_test/distribution.pyx":36
 *         for j in range(width):
 *             mew_sum += depth_image[i, j]
 *             count += 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "pmd_dust_test/distribution.pyx":38
 *             count += 1
 * 
 *     cdef double std_dev, dev_sum = 0, dev_temp             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "pmd_dust_test/distribution.pyx":39
 * 
 *     cdef double std_dev, dev_sum = 0, dev_temp
 *     cdef double avg = mew_sum / count             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "pmd_dust_test/distribution.pyx":42
 * 
 *     # Calculates the standard deviation
 *     for i in range(height):  # , nogil=True):             # <<<<<<<<<<<<<<
 *         for j in range(width):
 ...
 */
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    ...
    /* "pmd_dust_test/distribution.pyx":43
 *     # Calculates the standard deviation
 *     for i in range(height):  # , nogil=True):
 *         for j in range(width):             # <<<<<<<<<<<<<<
 *             dev_temp = depth_image[i, j] - avg
 ...
 */
    ...
    for (__pyx_t_6 = 0; __pyx_t_6 < __pyx_t_5; __pyx_t_6+=1) {
      ...
      /* "pmd_dust_test/distribution.pyx":44
 *     for i in range(height):  # , nogil=True):
 *         for j in range(width):
 *             dev_temp = depth_image[i, j] - avg             # <<<<<<<<<<<<<<
 *             dev_sum += dev_temp * dev_temp
 ...
 */
      ...
      __pyx_t_9 = -1;
      if (__pyx_t_10 < 0) {
        __pyx_t_10 += __pyx_v_depth_image.shape[0];
        if (unlikely(__pyx_t_10 < 0)) __pyx_t_9 = 0;
      } else if (unlikely(__pyx_t_10 >= __pyx_v_depth_image.shape[0])) __pyx_t_9 = 0;
      if (__pyx_t_11 < 0) {
        __pyx_t_11 += __pyx_v_depth_image.shape[1];
        if (unlikely(__pyx_t_11 < 0)) __pyx_t_9 = 1;
      } else if (unlikely(__pyx_t_11 >= __pyx_v_depth_image.shape[1])) __pyx_t_9 = 1;
      if (unlikely(__pyx_t_9 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_9);
        __PYX_ERR(0, 44, __pyx_L1_error)
      }
      __pyx_v_dev_temp = ((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_depth_image.data + __pyx_t_10 * __pyx_v_depth_image.strides[0]) ) + __pyx_t_11 * __pyx_v_depth_image.strides[1]) ))) - __pyx_v_avg);

      /* "pmd_dust_test/distribution.pyx":45
 *         for j in range(width):
 *             dev_temp = depth_image[i, j] - avg
 *             dev_sum += dev_temp * dev_temp             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "pmd_dust_test/distribution.pyx":47
 *             dev_sum += dev_temp * dev_temp
 * 
 *     std_dev = sqrt(dev_sum / count)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "pmd_dust_test/distribution.pyx":61
 *     #             result[ij] = 0
 * 
 *     return avg, std_dev             # <<<<<<<<<<<<<<
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_12 = PyFloat_FromDouble(__pyx_v_avg); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 61, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_12);
  __pyx_t_13 = PyFloat_FromDouble(__pyx_v_std_dev); if (unlikely(!__pyx_t_13)) __PYX_ERR(0, 61, __pyx_L1_error)
 ...
 */
  ...
  __Pyx_AddTraceback("pmd_dust_test.distribution.normal_distribution", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
...
/* Python wrapper */
static PyObject *__pyx_pw_13pmd_dust_test_12distribution_3normal_distribution(PyObject *__pyx_self, PyObject *__pyx_arg_depth_image); /*proto*/
static char __pyx_doc_13pmd_dust_test_12distribution_2normal_distribution[] = "Calculates the standard deviation for this population";
static PyObject *__pyx_pw_13pmd_dust_test_12distribution_3normal_distribution(PyObject *__pyx_self, PyObject *__pyx_arg_depth_image) {
  __Pyx_memviewslice __pyx_v_depth_image = { 0, 0, { 0 }, { 0 }, { 0 } };
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("normal_distribution (wrapper)", 0);
  assert(__pyx_arg_depth_image); {
    __pyx_v_depth_image = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(__pyx_arg_depth_image, PyBUF_WRITABLE); if (unlikely(!__pyx_v_depth_image.memview)) __PYX_ERR(0, 27, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L3_error:;
  __Pyx_AddTraceback("pmd_dust_test.distribution.normal_distribution", __pyx_clineno, __pyx_lineno, __pyx_filename);
  ...
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_13pmd_dust_test_12distribution_2normal_distribution(__pyx_self, __pyx_v_depth_image);
...
static PyObject *__pyx_pf_13pmd_dust_test_12distribution_2normal_distribution(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_depth_image) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannySetupContext("normal_distribution", 0);
  __Pyx_XDECREF(__pyx_r);
  if (unlikely(!__pyx_v_depth_image.memview)) { __Pyx_RaiseUnboundLocalError("depth_image"); __PYX_ERR(0, 27, __pyx_L1_error) }
  __pyx_t_1 = __pyx_f_13pmd_dust_test_12distribution_normal_distribution(__pyx_v_depth_image, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 27, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "pmd_dust_test.distribution.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "pmd_dust_test.distribution.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "pmd_dust_test.distribution.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "pmd_dust_test.distribution._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"compute_depth_bytes", (PyCFunction)__pyx_pw_13pmd_dust_test_12distribution_1compute_depth_bytes, METH_O, 0},
  {"normal_distribution", (PyCFunction)__pyx_pw_13pmd_dust_test_12distribution_3normal_distribution, METH_O, __pyx_doc_13pmd_dust_test_12distribution_2normal_distribution},
  {0, 0, 0, 0}
};
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_pmd_dust_test__distribution) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "pmd_dust_test.distribution")) {
      if (unlikely(PyDict_SetItemString(modules, "pmd_dust_test.distribution", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "pmd_dust_test/distribution.pyx":5
 * 
 * cimport numpy as np
 * import numpy as np             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "pmd_dust_test/distribution.pyx":1
 * import cython             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init pmd_dust_test.distribution", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init pmd_dust_test.distribution");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
