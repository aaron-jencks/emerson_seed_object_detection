...
def train(train_dict, test_dict, iterations, model_dir, batch_size):
...
def indefinite_train(train_dict, test_dict, batch_iterations, model_dir, batch_size):

    try:
        while True:
            print(train(train_dict, test_dict, batch_iterations, model_dir, batch_size))
